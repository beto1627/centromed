...
<html>
    ...
    <a href="#" id="opcabecera" onClick="buscarpersona();">BuscarPersona</a>
    &nbsp;&nbsp;|&nbsp;&nbsp;
    <img src="images/persona.gif" width="10" heig="10" />
    <a href="#" id="opcabecera" onClick="nuevapersona();">NuevaPersona</a>
    <br /><br/>
    <div id="buscarpersona">
    </div><script>buscarpersona();</script>
    </body>
</html>